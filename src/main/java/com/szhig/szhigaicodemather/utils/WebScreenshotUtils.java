package com.szhig.szhigaicodemather.utils;
 ...
 * @BelongsPackage: com.szhig.szhigaicodemather.utils
 * @Author: shizhiguang
 * @CreateTime: 2025-09-21  09:34
 * @Description: TODO
 * @Version: 1.0
 */
@Slf4j
public class WebScreenshotUtils {
//    private static final WebDri
    ...
    private static void compressImage(String originalImagePath, String compressedImagePath) {
        // 压缩图片质量（0.1 = 10%质量）
        final float COMPRESSOIN_QUALITY = 0.3f;
        try {
    ...
    private static void waitForPageLoad(WebDriver driver) {
        try {
            ...
            // 等到document.readyState 为complete
